...
function seedData() {
  ...
  for (const [name, url] of categories) {
    db.run('INSERT INTO categories (name, image_url) VALUES (?, ?)', [name, url]);
  }
  ...
  const products = [
    ...
    ['Silk Scarf', 'Luxurious printed silk scarf', 899, 'https://images.unsplash.com/photo-1584030373081-f37b7bb4fa4e?w=400', 3, '["One Size"]', 'Multi', 4.3],
    ...
    ['Pleated Midi Skirt', 'Elegant pleated midi skirt in olive green', 1399, 'https://images.unsplash.com/photo-1577900232427-18219b9166a0?w=400', 4, '["XS","S","M","L"]', 'Olive', 4.5],
    ...
    ['Layered Gold Necklace', 'Delicate layered gold-plated necklace', 799, 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400', 6, '["One Size"]', 'Gold', 4.4],
  ...
  for (const p of products) {
    db.run('INSERT INTO products (name, description, price, image_url, category_id, sizes, color, rating) VALUES (?,?,?,?,?,?,?,?)', p);
  }
...
module.exports = { initDatabase, getDb, allRows, getRow };
